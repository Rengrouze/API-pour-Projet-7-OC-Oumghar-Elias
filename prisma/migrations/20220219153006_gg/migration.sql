/*
  ...
  - You are about to drop the column `_id` on the `reported_post` table. All the data in the column will be lost.
  ...
  - Made the column `user__id` on table `reported_post` required. This step will fail if there are existing NULL values in that column.
  - Made the column `post__id` on table `reported_post` required. This step will fail if there are existing NULL values in that column.
